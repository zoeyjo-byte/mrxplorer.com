export const CATALOG = {
  'Prompt Frameworks for Better Results': { price: 129, type: 'individual' },
  'AI as a Thinking Partner': { price: 129, type: 'individual' },
  'Chat / Projects / Cowork / Code(x)': { price: 129, type: 'individual' },
  'Hallucination, Pricing, and Privacy Basics': { price: 129, type: 'individual' },
  'Chat / Projects / Cowork / Code(x) (Intermediate)': { price: 199, type: 'individual' },
  'Quantitative Analysis with an LLM': { price: 199, type: 'individual' },
  'Building and Working with Agents': { price: 199, type: 'individual' },
  'Projects — When You Actually Want a Siloed Experience': { price: 199, type: 'individual' },
  'Data Privacy and Security': { price: 199, type: 'individual' },
  'When to Automate': { price: 199, type: 'individual' },
